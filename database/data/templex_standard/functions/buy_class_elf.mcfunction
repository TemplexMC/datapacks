...
tag @s[scores={TC=300..}] add hasClass
scoreboard players set @s[scores={TC=300..}] ElvenLevel 1
scoreboard players set @s[scores={TC=300..}] ElvenEff 1
scoreboard players set @s[scores={TC=300..}] ElvenSpeed 1
