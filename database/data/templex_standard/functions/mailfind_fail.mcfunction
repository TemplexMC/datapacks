...
tellraw @a[tag=OP] [{"text":"New TPA System","color":"gold"},{"text":" : ","color":"dark_gray"},{"selector":"@s","color":"green"},{"text":" just tried to go to someone's mailbox with a UUID of ","color":"red"},{"score":{"name":"@s","objective":"Mail"}},{"text":", but either that player hasn't bought a mailbox or ","color":"red"},{"selector":"@s","color":"green"},{"text":" didn't supply the correct UUID...","color":"red"}]
