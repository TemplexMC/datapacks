...
# Tellraw.
execute as @e[name=Proxy1,type=armor_stand,scores={Database=1}] run tellraw @a [{"text":"Vote to turn it to day \u00A75[\u00A7bA \u00A7bscore \u00A7bof ","color":"gold"},{"score":{"name":"@e[name=Proxy4,type=armor_stand]","objective":"VoteDay"},"color":"gold"},{"text":" \u00A7bis \u00A7bneeded \u00A7bfor \u00A7bday\u00A75]\u00A76:","color":"gold"}]
...
# Doing.
execute as @e[name=Proxy1,type=armor_stand,scores={Database=1}] run scoreboard players add @a[nbt={Sleeping:1b}] VoteDay 1
# Enabling.
...
execute as @e[name=Proxy2,type=armor_stand,scores={Database=0}] run time set 2147448001
...
execute as @e[name=Proxy2,type=armor_stand,scores={Database=0}] run scoreboard players reset @e[name=Proxy1,scores={Database=1..}] Database
...
# Timer done.
#execute as @e[name=Proxy1,type=armor_stand,scores={Database=6000..}] run scoreboard players reset * VSLEEP
execute as @e[name=Proxy1,type=armor_stand,scores={Database=6000..}] run tag @a remove VSLEEP
execute as @e[name=Proxy1,type=armor_stand,scores={Database=6000..}] run tag @a remove SleepVoted
execute as @e[name=Proxy1,type=armor_stand,scores={Database=6000..}] run scoreboard players reset @a VoteDay
execute as @e[name=Proxy1,type=armor_stand,scores={Database=6000..}] run scoreboard players reset @a VoteNight
execute as @e[name=Proxy1,type=armor_stand,scores={Database=6000..}] run scoreboard players reset @e[name=Proxy2,type=armor_stand] VoteDay
execute as @e[name=Proxy1,type=armor_stand,scores={Database=6000..}] run scoreboard players reset @e[name=Proxy3,type=armor_stand] VoteDay
execute as @e[name=Proxy1,type=armor_stand,scores={Database=6000..}] run tellraw @a [{"text":"The majority of players do not want day right now... Keeping night.","color":"gray"}]
execute as @e[name=Proxy1,type=armor_stand,scores={Database=6000..}] run scoreboard players set @s Database 0
