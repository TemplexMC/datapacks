## None.
#  Teller.
execute as @s[scores={UpgradeClass=1}] run tellraw @s [{"text":"\u00A7cSpecify different classes\u00A78: \u00A7aElf \u00A77is \u00A762\u00A78."}]
execute as @s[scores={UpgradeClass=1}] run tellraw @s [{"text":"\u00A76Class Upgrader \u00A78: "},{"selector":"@s","color":"green"},{"text":" was just shown a list of upgradable classes.","color":"red"}]
## Elf.
#  Not enough.
execute as @s[scores={UpgradeClass=2}] as @s[tag=!hasElf] run tellraw @s [{"text":"I'm sorry, but you do not have the Elf Clas...","color":"red"}]
...
## More.
execute as @s[scores={UpgradeClass=3..}] run tellraw @s [{"text":"\u00A7cThat is not a class!"}]
execute as @s[scores={UpgradeClass=3..}] run tellraw @s [{"text":"\u00A7cSpecify different classes\u00A78: \u00A7aElf \u00A77is \u00A762\u00A78."}]
execute as @s[scores={UpgradeClass=3..}] run tellraw @s [{"text":"\u00A76Class Upgrader \u00A78: "},{"selector":"@s","color":"green"},{"text":" just tried to upgrade a class that didn't exist...","color":"red"}]
## Resetters.
