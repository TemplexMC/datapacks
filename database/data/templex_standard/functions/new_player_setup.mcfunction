...
# Gives starter items.
give @s wooden_sword{display:{LocName:"Foam Dagger",Lore:["Should it bend this much?"]},ench:[{id:16,lvl:3}]} 1
give @s bread{display:{LocName:"Mana",Lore:["Tastes stale... :/"]}} 10
give @s white_wool{display:{LocName:"Cotton Candy",Lore:["Ew. Tastes like fur!"]}} 3
give @s coal{display:{LocName:"Chocolate",Lore:["It's a bit hard..."]}} 8
