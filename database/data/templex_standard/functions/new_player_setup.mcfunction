...
# Gives starter items.
give @s wooden_sword{display:{LocName:"{\"text\":\"Foam Dagger\",\"color\":\"gold\"}",Lore:["Should it bend this much?"]},ench:[{id:16,lvl:3}]} 1
give @s bread{display:{LocName:"{\"text\":\"Mana\",\"color\":\"red\"}",Lore:["Tastes stale... :/"]}} 10
give @s white_wool{display:{LocName:"{\"text\":\"Cotton Candy\",\"color\":\"red\"}",Lore:["Ew. Tastes like fur!"]}} 3
give @s coal{display:{LocName:"{\"text\":\"Chocolate\",\"color\":\"red\"}",Lore:["It's a bit hard..."]}} 8
