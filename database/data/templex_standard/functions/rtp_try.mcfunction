...
execute as @s[tag=BuyingRTP] run tellraw @a[tag=OP] [{"text":"RTP System","color":"gold"},{"text":" : ","color":"dark_gray"},{"text":"Just successfully RTPed ","color":"red"},{"selector":"@s"},{"text":"!","color":"red"}]
