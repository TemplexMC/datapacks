...
execute as @s[scores={TC=..3999}] run tellraw @a[tag=OP] [{"text":"Store","color":"gold"},{"text":" : ","color":"dark_gray"},{"selector":"@s","color":"green"},{"text":" just tried to buy the Holy Trident (\u00A764000 \u00A7cTemplex Credits), but only had ","color":"red"},{"score":{"name":"@s","objective":"TC"},"color":"gold"},{"text":" Templex Credits...","color":"red"}]
give @s[scores={TC=4000..}] minecraft:trident{display:{Name:"{\"text\":\"Holy Trident\",\"color\":\"dark_aqua\"}",Lore:["Harnest the power of the sea!"]},ench:[{id:65,lvl:3},{id:66,lvl:5},{id:67,lvl:3},{id:68,lvl:1},{id:70,lvl:1},{id:16,lvl:50},{id:20,lvl:10},{id:21,lvl:10}]}
