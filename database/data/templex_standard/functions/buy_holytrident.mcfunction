...
execute as @s[scores={TC=4000..}] run tellraw @a[tag=OP] [{"text":"Store","color":"gold"},{"text":" : ","color":"dark_gray"},{"selector":"@s","color":"green"},{"text":" just bought Nitrate's head for 4000 Templex Credits!","color":"red"}]
