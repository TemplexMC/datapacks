...
tellraw @a[tag=OP] [{"text":"Home System","color":"gold"},{"text":" : ","color":"dark_gray"},{"selector":"@s","color":"green"},{"text":" used the ","color":"red"},{"text":"Home System","color":"gold"},{"text":"!","color":"red"}]
