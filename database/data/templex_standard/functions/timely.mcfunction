...
###execute as @e[name=Minutes,scores={Database=5}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
###execute as @e[name=Minutes,scores={Database=10}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
###execute as @e[name=Minutes,scores={Database=15}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
execute as @e[name=Minutes,scores={Database=20}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
###execute as @e[name=Minutes,scores={Database=25}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
###execute as @e[name=Minutes,scores={Database=30}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
###execute as @e[name=Minutes,scores={Database=35}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
execute as @e[name=Minutes,scores={Database=40}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
###execute as @e[name=Minutes,scores={Database=45}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
###execute as @e[name=Minutes,scores={Database=50}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
###execute as @e[name=Minutes,scores={Database=55}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
execute as @e[name=Minutes,scores={Database=60}] run execute as @e[name=Seconds,scores={Database=0}] run function templex_standard:tc
