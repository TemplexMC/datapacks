...
team modify HeadSysadmin color gray
team modify HeadAdmin color gray
team modify HeadMod color gray
team modify HeadBuilder color gray
team modify Sysadmin color gray
team modify SysYT color gray
...
team modify Templexian color gray
team modify DNRP color gray        
team modify MVPP color gray
team modify MVP color gray
team modify VIPP color gray 
team modify VIP color gray 
team modify YT color gray  
team modify Streamer color gray
team modify JrYT color gray  
team modify JrStreamer color gray
#team modify Dedicated color gray 
...
team modify DNRP prefix [{"text":"\u00A7dEmperor "}]
team modify DNRP suffix [{"text":" \u00A7cBought Rank"}]
team modify MVPP prefix [{"text":"\u00A7bChancellor "}]
team modify MVPP suffix [{"text":" \u00A7cBought Rank"}]
team modify MVP prefix [{"text":"\u00A7bSith "}]
team modify MVP suffix [{"text":" \u00A7cBought Rank"}]
team modify VIPP prefix [{"text":"\u00A7aJedi "}]
team modify VIPP suffix [{"text":" \u00A7cBought Rank"}]
team modify VIP prefix [{"text":"\u00A7aPadawan "}]
team modify VIP suffix [{"text":" \u00A7cBought Rank"}]
...
team modify LPURPLE color light_purple
# Tell.
