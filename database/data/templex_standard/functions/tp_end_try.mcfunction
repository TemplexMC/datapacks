...
execute as @s[scores={Karma=3000..},tag=!endcmplt] run tag @s add getEndCmplt
execute as @s[scores={Karma=3000..},tag=!endcmplt] run scoreboard players remove @s Karma 3000
execute as @s[tag=getEndCmplt] run tag @s add endcmplt
execute as @s[tag=getEndCmplt] run tag @s remove getEndCmplt
