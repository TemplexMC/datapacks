...
execute at @s[team=MVP] run particle explosion ~ ~ ~ 1 1 1 0.001 1 force @a
execute at @s[team=MVPP] run particle lava ~ ~ ~ 1 1 1 0.001 1 force @a
execute at @s[team=DNRP] run particle underwater ~ ~ ~ 1 1 1 0.001 1 force @a

execute at @s[team=Streamer] run particle totem_of_undying ~ ~ ~ 1 1 1 0.001 1 force @a
execute at @s[team=JrStreamer] run particle totem_of_undying ~ ~ ~ 1 1 1 0.001 1 force @a
execute at @s[team=YT] run particle lava ~ ~ ~ 1 1 1 0.001 1 force @a
execute at @s[team=JrYT] run particle lava ~ ~ ~ 1 1 1 0.001 1 force @a
execute at @s[team=Templexian] run particle note ~ ~ ~ 1 1 1 0.001 2 force @a
#execute at @s[team=HighKing] run particle underwater ~ ~ ~ 1 1 1 0.001 7 force @a

execute at @s[team=TCrusader] run particle totem_of_undying ~ ~0.2 ~ 1.2 0.3 1.2 0.005 5 force @a
execute at @s[team=TAssassin] run particle sweep_attack ~ ~ ~ 1 1 1 0.001 1 force @a
...
#execute at @s[name=SWATMAN4U777] run particle portal ~ ~ ~ 1 1 1 0.001 1 force @a
execute at @s[name=Neonahh_xo] run particle spit ~ ~ ~ 1 1 1 0.001 1 force @a
execute at @s[name=Bob_Ross2435] run particle flame ~ ~ ~ 1 1 1 0.001 1 force @a
