...
execute as @s[scores={Karma=700..}] run summon Shulker ~ ~ ~ {CustomName:"Store Bought"}
execute as @s[scores={Karma=700..}] run tellraw @a[tag=OP] [{"text":"Shulker System","color":"gold"},{"text":" : ","color":"dark_gray"},{"selector":"@s"},{"text":" has just bought a Shulker for 700 Karma!","color":"red"}]
execute as @s[scores={Karma=700..}] run tellraw @s [{"text":"Successfully bought a Shulker.","color":"green","italic":"true"}]

execute as @s[scores={Karma=..699}] run tellraw @a[tag=OP] [{"text":"Shulker System","color":"gold"},{"text":" : ","color":"dark_gray"},{"selector":"@s"},{"text":" just tried to buy a Shulker, but didn't have enough Karma...\n","color":"red"},{"text":"Thier Karma: ","color":"gray"},{"score":{"name":"@s","objective":"Karma"},"color":"gold"},{"text":"\nTheir RTPs: ","color":"gray"},{"score":{"name":"@s","objective":"RTPs"},"color":"gold"}]
