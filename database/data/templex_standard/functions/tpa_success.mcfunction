...
execute as @a[score_TPSend_min=1] run tellraw @s [{"text":"Successfully TPed you to ","color":"red"},{"selector":"@a[score_TPHere_min=1]"},{"text":"!","color":"red"}]
execute as @a[score_TPHere_min=1] run tellraw @s [{"text":"Successfully TPed ","color":"red"},{"selector":"@a[score_TPSend_min=1]"},{"text":" to you!","color":"red"}]
