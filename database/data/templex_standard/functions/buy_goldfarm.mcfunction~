...
give @s[scores={Karma=30000..}] minecraft:trident{display:{Name:"{\"text\":\"Holy Trident\",\"color\":\"dark_aqua\"}",Lore:["Harnest the power of the sea!"]},ench:[{id:65,lvl:3},{id:66,lvl:5},{id:68,lvl:1},{id:70,lvl:1},{id:16,lvl:50},{id:20,lvl:10},{id:21,lvl:10}]}
