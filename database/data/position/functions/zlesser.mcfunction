...
execute as @e[name=Proxy1,type=armor_stand,scores={zPos=..10000000}] run scoreboard players add @s zPos 10000000
# < -1,000,000
execute if entity @e[name=Proxy1,type=armor_stand,scores={zPos=..1000000}] run teleport @s ~ ~ ~-1000000
execute as @e[name=Proxy1,type=armor_stand,scores={zPos=..1000000}] run scoreboard players add @s zPos 1000000
# < -100,000
...
execute as @e[name=Proxy1,type=armor_stand,scores={zPos=..1000}] run scoreboard players add @s zPos 1000
# < -100
execute if entity @e[name=Proxy1,type=armor_stand,scores={zPos=..100}] run teleport @s ~ ~ ~-100
execute as @e[name=Proxy1,type=armor_stand,scores={zPos=..100}] run scoreboard players add @s zPos 100
# < -10
execute if entity @e[name=Proxy1,type=armor_stand,scores={zPos=..10}] run teleport @s ~ ~ ~-10
execute as @e[name=Proxy1,type=armor_stand,scores={zPos=..10}] run scoreboard players add @s zPos 10
# < -1
execute if entity @e[name=Proxy1,type=armor_stand,scores={zPos=..1}] run teleport @s ~ ~ ~-1
execute as @e[name=Proxy1,type=armor_stand,scores={zPos=..1}] run scoreboard players add @s zPos 1
