...
execute as @s[tag=QIII,tag=!10milTaggedZ] run scoreboard players add @s zPos 10000000
...
execute as @s[tag=QIII,tag=!1milTaggedZ] run scoreboard players add @s zPos 1000000 
...
execute as @s[tag=QIII,tag=!100kTaggedZ] run scoreboard players add @s zPos 100000
...
execute as @s[tag=QIII,tag=!10kTaggedZ] run scoreboard players add @s zPos 10000  
...
execute as @s[tag=QIII,tag=!1kTaggedZ] run scoreboard players add @s zPos 1000 
...
execute as @s[tag=QIII,tag=!100TaggedZ] run scoreboard players add @s zPos 100    
...
execute as @s[tag=QIII,tag=!10TaggedZ] run scoreboard players add @s zPos 10     
...
execute as @s[tag=QIII,tag=!1TaggedZ] run scoreboard players add @s zPos 1 
