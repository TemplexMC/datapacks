...
execute @s[score_Inputter=15,tag=betaTester,score_Dummy3_min=1] ~ ~ ~ tp @s 324 90 -273 45 0
...
execute @s[score_Inputter_min=16,score_ShovelTick_min=1,tag=!InShovel] ~ ~ ~ tellraw @s [{"text":"This game is already full! Sorry, try again once it has finished.","color":"red"}]
...
execute @s[tag=!InShovel,score_Shovel_min=1] ~ ~ ~ tp @s 324 90 -273 45 0
