...
# Addons below #
scoreboard players set @e[type=Ender_dragon,tag=!loot] Var 37
scoreboard players set @e[type=Shulker,tag=!loot] Var 38
execute @e[tag=!loot,type=Ender_dragon,score_Var=37,score_Var_min=37] ~ ~ ~ entitydata @s {Tags:["loot"],DeathLootTable:"mobs:end/ender_dragon"}
execute @e[tag=!loot,type=Shulker,score_Var=38,score_Var_min=38] ~ ~ ~ entitydata @s {Tags:["loot"],DeathLootTable:"mobs:end/shulker"}
