...
execute as @p[distance=..200,gamemode=adventure] as @e[limit=1,name=Zombies,distance=..200,type=armor_stand,tag=Zombs] at @s run function minigames:zombs_engine
