...
execute as @a[tag=InZombs] at @s run scoreboard players add @e[type=armor_stand,tag=Zombs,distance=..7,name=Boss] Database 1
...
execute as @e[tag=Zombs,type=armor_stand,scores={Database=100..},name=Boss,tag=!Summoned] at @s run summon wither_skeleton ~ ~ ~ {CustomName:"{\"text\":\"NitrateOrigins\",\"color\":\"aqua\"}",CustomNameVisible:1b,Tags:["ZombsNK"]}
execute as @e[tag=Zombs,type=armor_stand,scores={Database=100..},name=Boss,tag=!Summoned] at @s run tellraw @a [{"text":"Zombs","color":"gold"},{"text":" : ","color":"dark_gray"},{"text":"\u00A74WARNING! \u00A7bThe boss has spawned!","color":"aqua"}]
execute as @e[tag=Zombs,type=armor_stand,scores={Database=100..},name=Boss,tag=!Summoned] at @s run tag @e[name=ZombsBoolean,type=armor_stand,tag=!true] add true
execute as @e[tag=Zombs,type=armor_stand,scores={Database=100..},name=Boss,tag=!Summoned] at @s run tag @s add Summoned
...
execute as @a[tag=InZombs,tag=ZTold,tag=STold,tag=ETold] run give @s wooden_pickaxe{display:"{\"text\":\"Bar Breaker\",\"color\":\"aqua\"}",CanDestroy:["minecraft:iron_bars"],Damage:58} 1
execute as @a[tag=InZombs,tag=ZTold,tag=STold,tag=ETold] run scoreboard players reset @s ZKillZombie
execute as @a[tag=InZombs,tag=ZTold,tag=STold,tag=ETold] run scoreboard players reset @s ZKillSkeleton
execute as @a[tag=InZombs,tag=ZTold,tag=STold,tag=ETold] run scoreboard players reset @s ZKillEndermite
