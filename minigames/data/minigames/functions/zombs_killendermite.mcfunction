...
execute as @s[tag=InZombs] run tellraw @s [{"text":"Endermites\u00A78: ","color":"dark_purple"},{"score":{"name":"@e[type=armor_stand,name=ZombsCurrStats]","objective":"ZKillEndermite"},"color":"gold"},{"text":"\u00A78/\u00A7610 \u00A7aneeded","color":"green"}]
# Resetting.
