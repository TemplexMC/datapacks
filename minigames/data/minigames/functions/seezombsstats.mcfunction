...
tellraw @s [{"text":"\u00A75This Game Zombie Kills\u00A78: ","color":"dark_purple"},{"score":{"name":"@e[type=armor_stand,name=ZombsCurrStats]","objective":"ZKillZombie"},"color":"gold"}]
tellraw @s [{"text":"\u00A75This Game Skeleton Kills\u00A78: ","color":"dark_purple"},{"score":{"name":"@e[type=armor_stand,name=ZombsCurrStats]","objective":"ZKillSkeleton"},"color":"gold"}]
tellraw @s [{"text":"\u00A75This Game Endermite Kills\u00A78: ","color":"dark_purple"},{"score":{"name":"@e[type=armor_stand,name=ZombsCurrStats]","objective":"ZKillEndermite"},"color":"gold"}]
