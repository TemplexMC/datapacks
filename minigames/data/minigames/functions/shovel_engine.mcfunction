...
execute as @a[tag=!InShovel,distance=..100,gamemode=adventure] run scoreboard players set @e[name=ShovelAlive,type=armor_stand] Database 0
...
execute if entity @a[tag=!InShovel,distance=..100,gamemode=adventure] as @a[tag=InShovel] run scoreboard players add @e[name=ShovelAlive,type=armor_stand] Database 1
...
execute as @a[tag=!InShovel,distance=..100,gamemode=adventure] run scoreboard players add @e[name=ShovelAlive,type=armor_stand] Database 1
...
execute as @a[tag=InShovel,distance=..100] at @s if block ~ ~ ~ minecraft:water run tag @s add Fallen
execute as @a[tag=InShovel,distance=..100] at @s if block ~ ~ ~ minecraft:water run scoreboard players remove @e[name=ShovelAlive,type=armor_stand] Database 1
execute as @a[tag=InShovel,distance=..100] at @s if block ~ ~ ~ minecraft:water run tellraw @a [{"text":"Shovel Minigame","color":"gold"},{"text":" : ","color":"dark_gray"},{"selector":"@s"},{"text":" has been eliminated from the Shovel game!","color":"red"}]
execute as @a[tag=InShovel,distance=..100] at @s if block ~ ~ ~ minecraft:water run tp @s -649439 49 -601071
...
execute as @e[name=ShovelStartCount,type=armor_stand] as @s[scores={Database=100}] run tp @a[tag=InShovel,distance=..100] -649439 45 -601071
...
effect give @a[tag=InShovel,distance=..100] minecraft:resistance 1 100 true
## Ending the game
...
execute as @e[name=ShovelAlive,type=armor_stand,scores={Database=1}] as @e[name=Shovel,type=armor_stand] at @s run tag @p[tag=InShovel,tag=!Fallen] add ShovelWinner
execute as @a[tag=ShovelWinner] run title @a[tag=InShovel,distance=..100] actionbar [{"selector":"@s","color":"green"},{"text":" has won!","color":"green"}]
execute as @p[tag=ShovelWinner] run scoreboard players add @e[name=ShovelEndCount,type=armor_stand] Database 1
#  TL;DR
execute as @e[name=ShovelEndCount,type=armor_stand] as @s[scores={Database=20}] as @e[name=Shovel,type=armor_stand] at @s run tellraw @a[distance=100] [{"text":"Shovel Minigame","color":"gold"},{"text":" : ","color":"dark_gray"},{"text":"Returning all players to Spawn in 5 seconds...","color":"red"}]
...
execute as @e[name=ShovelEndCount,type=armor_stand] as @s[scores={Database=120}] as @e[name=Shovel,type=armor_stand] at @s run tellraw @a[distance=100] [{"text":"Shovel Minigame","color":"gold"},{"text":" : ","color":"dark_gray"},{"text":"Returning all players to Spawn...","color":"red"}]
execute as @e[name=ShovelEndCount,type=armor_stand] as @s[scores={Database=120}] run tellraw @a [{"text":"Shovel Minigame","color":"gold"},{"text":" : ","color":"dark_gray"},{"selector":"@a[tag=ShovelWinner]","color":"green"},{"text":" has just won a game of the Shovel Minigame!","color":"red"}]
...
execute as @e[name=ShovelEndCount,type=armor_stand] as @s[scores={Database=120}] run fill -649420 44 -601052 -649458 44 -601090 minecraft:snow_block
...
execute as @e[name=ShovelEndCount,type=armor_stand] as @s[scores={Database=120}] run scoreboard players reset @e[name=InShovel,type=armor_stand] Database
